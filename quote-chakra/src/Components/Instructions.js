...
const Instructions = ({gameDispatch}) => {
  ...
  const animationLeft = window.innerWidth < 1000 ? smallAnimationLeft : largeAnimationLeft
  const animationRight = window.innerWidth < 1000 ? smallAnimationRight : largeAnimationRight
